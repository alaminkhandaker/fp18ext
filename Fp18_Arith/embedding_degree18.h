...
void Fp_add(struct Fp *RES,struct Fp *a,struct Fp *b);//RES=a+b mod p
void Fp_add_ui(struct Fp *RES,struct Fp *a,unsigned long int b);//RES=a+b mod p
void Fp_sub(struct Fp *RES,struct Fp *a,struct Fp *b);//RES=a-b mod p
void Fp_sub_ui(struct Fp *RES,struct Fp *a,unsigned long int b);//RES=a-b mod p
void Fp_mul(struct Fp *RES,struct Fp *a,struct Fp *b);//RES=a*b mod p
void Fp_mul_ui(struct Fp *RES,struct Fp *a,unsigned long int b);//RES=a*b mod p
void Fp_mul_c1(struct Fp *RES,struct Fp *a);//RES=a*b mod p
void Fp_inv(struct Fp *RES,struct Fp *a);
void Fp_div(struct Fp *RES,struct Fp *a,struct Fp *b);//RES=a/b mod p
...
void EFp_ECA(struct EFp *RES, struct EFp *P1, struct EFp *P2);//RES=P1+P2
...
void EFp3_ECD(struct EFp3 *RES, struct EFp3 *P);//RES=2*P
void EFp3_ECA(struct EFp3 *RES, struct EFp3 *P1, struct EFp3 *P2);//RES=P1+P2
...
void EFp6_ECD(struct EFp6 *RES, struct EFp6 *P);//RES=2*P
void EFp6_ECA(struct EFp6 *RES, struct EFp6 *P1, struct EFp6 *P2);//RES=P1+P2
...
void EFp18_ECD(struct EFp18 *RES, struct EFp18 *P);//RES=2*P
void EFp18_ECA(struct EFp18 *RES, struct EFp18 *P1, struct EFp18 *P2);//RES=P1+P2
